...
if(isset($_POST['submit'])){
   ...
   if($select->rowCount() > 0){    //check number of rows that match to select statement
      ...
      if($pass != $cpass){
         ...
         if($insert){
            if($image_size > 2000000){
               ...
               header('location:login.php');            //we can login
            }
         }
...
if(isset($message)){  //message if email exits or not
